            ...
            <div class="row">
                <div class="col-md-8 offset-lg-2 bg-red shadow rounded">
                    <div class="py-3 m-1">
                        ...
                        <a href="<?php echo e(route('add-category')); ?>" class="btn-sm btn-primary float-right">Ajouter une
                            catégorie</a>
                        </h4>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('edit-category', encrypt($category->id))); ?>"
                                                    ...
                                                    <div class="modal-content bg-white">
                                                        <div class="modal-header bg-danger text-right">
                                                            <h5 class="modal-title text-white" id="exampleModalLabel">Delete
                                                                this item <?php echo e($category->name); ?></h5>
                                                            <button type="button" class="close"
                                                                data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form action="<?php echo e(route('deleteCategory', $category->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Utilisateur\OneDrive\سطح المكتب\DW\3W Academy\Laravel\larashop\resources\views/categories/index.blade.php ENDPATH**/ ?>